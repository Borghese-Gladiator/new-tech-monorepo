...
#   UTILS
#======================
def build_et_process() -> Process:
    """
    Helper function to set up an ExtractThinker process using
    local LLM endpoints (e.g., Ollama, LocalAI, OnPrem.LLM, etc.)
    """
