...
- `agent-workbench-live/.claude/commands/plan.md` — `Context: @context/meta/repo-discovery.md, @context/meta/risk-and-approval.md`.
- `agent-workbench-live/.claude/commands/validate.md` — `Context: @context/meta/repo-discovery.md, @context/git/draft-pr.md, @context/infra/ci.md`.
- `agent-workbench-live/.claude/commands/start.md` — `Context: @context/git/worktrees.md`.
- `agent-workbench-live/.claude/commands/followups.md` — `Context: @context/meta/risk-and-approval.md`.
- `agent-workbench-live/.claude/commands/new-run.md` — `Context: @context/meta/context-authoring.md`.
...
6. `agent-workbench-live/.claude/commands/plan.md` — sample one wired command to confirm the `Context:` line is placed near the top, ahead of step bodies.
...
| Relevant `.claude/commands/*` compose targeted imports | `grep -E '^Context:' agent-workbench-live/.claude/commands/*.md` returns 5 entries. |
...
None. Wiring landed exactly as plan.md proposed.
...
- `agent-workbench-live/.claude/commands/plan.md` — added `Context:` import line.
- `agent-workbench-live/.claude/commands/validate.md` — added `Context:` import line.
- `agent-workbench-live/.claude/commands/start.md` — added `Context:` import line.
- `agent-workbench-live/.claude/commands/followups.md` — added `Context:` import line.
- `agent-workbench-live/.claude/commands/new-run.md` — added `Context:` import line.
